                      ...
                      <ol className="space-y-0.5">
                        {menu.programs.map((program, index) => (
                          <li
                            ...
                            className="flex items-start group hover:bg-blue-50 rounded-md p-1.5 -ml-2 transition-colors"
                          >
                            <span className="text-blue-500 font-semibold mr-2 mt-0.5 min-w-[1.5rem] text-xs">
                              {index + 1}.
                            </span>
                            <Link
                              to={`/module/${moduleCode}/${program.programCode}`}
                              className="text-gray-700 group-hover:text-blue-600 font-medium flex-1 hover:underline cursor-pointer text-xs whitespace-nowrap overflow-hidden text-ellipsis"
